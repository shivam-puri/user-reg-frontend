...
function Landing() {
    ...
    return (
        <div className='flex w-full flex-col min-h-screen bg-secondary items-center justify-center' >
            ...
            <br />
            <a href="https://github.com/shivam-puri/user-reg-backend/tree/main?tab=readme-ov-file#api-documentation" target="_blank" rel="noopener noreferrer">CLICK HERE TO GO TO THE REST API DOCUMENTATION</a>
        </div>
    )
}
